  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "should set a flash error if the friend_id params is missing" do
        get :new, {}
        assert_equal "Friend requiered", flash[:error]
      end
      ...
      should "returns a 404 status if no friend is find" do
    ...
    context"when logged in" do
      ...
      context "with a valid friend_id" do
       ...
       should "set the flash success message" do
         ...
         assert_equal "You are now friend with #{users(:mike).full_name}", flash[:success]
       end
      end
    end
  end
